...
@section('content')
    <div class="container mx-auto max-w-screen-md">
        <div class="flex flex-wrap justify-center">
                            ...
                            <div class="flex flex-wrap">
                                <button
                                    ...
                                    class="bg-green-500 w-full hover:bg-green-700 text-gray-100 
                                                                        p-3 focus:outline-none focus:shadow-outline uppercase font-bold mb-2"
                                >
                                    {{ __('Register') }}
                                </button>
                            </div>
            ...
            <div class="md:w-1/2 order-1 md:order-1 text-center flex flex-col justify-center px-10 mt-10">
                <h1 class="text-green-700 text-3xl">¿Eres reclutador?</h1>
