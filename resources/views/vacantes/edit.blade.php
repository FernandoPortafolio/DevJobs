...
@section('content')
    ...
    >
        ...
        <div class="mb-5">
            <label class="block text-gray-700 text-sm mb-2">Imagen Actual:</label>
            <img
            ...
            const dropzone = new Dropzone('#dropzone-devjobs', {
                ...
                init: function() {
                    if (document.querySelector('#image_name').value.trim()) {
                        ...
                        publishedImage.serverName = document.querySelector('#image_name').value
                ...
                removedfile: function(file, response) {
                    ...
                    const deleteName = file.serverName
